...
| Rate-limit counters (hashed email/IP/account id) | erased by the sweep once no live window can use them | window length, at most 24 hours | abuse prevention without retaining raw identifiers |
